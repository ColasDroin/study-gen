...
def _get_multiple_merge_parameters(
...
def get_multiple_merge_str(
    ...
    dict_parameters = _get_multiple_merge_parameters(l_blocks, output)

    # Ensure that the output is accessible
    _check_external_merge_output(l_blocks, dict_parameters, output)
